...
import json 
import numpy as np
from postproc import clustercount3
dir_path='D:/Vstudio/Vscode/CounTX_Berry/CounTX_Berry/img/datas/images_384_VarV2/'                                #path to the directory containing the images.
...
tresh=[[y/1000 for y in range(20,80,5)]]
        ...
        for mxl in mxlen:
            for sqsz1 in sqsz:
                for text in queryes:
                    ...
                    for k in keys:
                        if anno[k]["data_split"]=="train":
                            
                            filename = k#os.fsdecode(file)
